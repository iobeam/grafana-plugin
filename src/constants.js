...
export const DEFAULT_SELECT_FIELD = "-- select field --";
export const DEFAULT_SELECT_NS = "-- select namespace --";
export const DEFAULT_SELECT_PROJECT = "-- select project --";
export const DEFAULT_DEVICE = "-- select device --";
